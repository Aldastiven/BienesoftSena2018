 ...
 <h1 id="title_container">TABLA PATROCINIO(Coordinador)</h1>
     ...
     <div id="table"  class="table" style="margin-top: -10px;">
        ...
        <thead id="thead" class="thead">
            <th id="th_thead">ID patrocinio</th>
            <th id="th_thead">ID aprendiz</th>
            <th id="th_thead">Numero de contrato</th>
            <th id="th_thead">Estado</th>
            <th id="th_thead">Fecha de contarto</th>   
        ...
        <form action="ServletAprendiz_rel_Patrocinio" method="post">
            ...
            <td><input  class="browser-default" type="number" name="t_patrocinio_pat_id" value="<%=x.getPatrocinio_Pat_ID()%>"></td>
            <td><input  class="browser-default" type="number" name="t_aprendiz_apr_documento" value="<%=x.getPat_Aprendiz_Apr_documento()%>"></td>
            <td><input  class="browser-default" type="number" name="t_numeroContrato" value="<%=x.getPat_numeroContrato()%>"></td>
            <td><input  class="browser-default" type="text" name="t_estado" value="<%=x.getPat_estado()%>"></td>
            <td><input  class="browser-default" type="date" name="t_fechaContrato" value="<%=x.getPat_fechaContrato()%>"></td>
...
<h1 id="title">consultas patrocinio</h1>
        <div id="div_principal" class="">              
                <%
                        ArrayList<aprendiz_rel_patrocinioSG> consulta = new ArrayList<>();
                        consulta = con.consultaAprendiz_rel_Patricinio();
                        for (int i = 0; i< consulta.size(); i++ ){
                        x= consulta.get(i);
                %>
                        <div class="divuno" id="divuno">
                            <input class="browser-default" id="txt" type="text"  value="<%=x.getPat_Aprendiz_Apr_documento()%> <%=x.getPat_estado()%> " readonly>
                        </div>
                            ...
                            <div class="modal-cont l12 s12 m12" id="modal-cont" >
                                    ...
                                    <div class="row">
                                            <div class="input-field col s12 l6 m6">
                                                <p id="input_msg_modal">ID del patrocinio</p>
                                                <br>
                                                <input id="input_txt_modal" type="number" name="t_patrocinio_pat_id" value="<%=x.getPatrocinio_Pat_ID()%>">
                                            </div>

                                            <div class="input-field col s12 l6 m6">
                                                <p id="input_msg_modal">ID del aprendiz</p>
                                                <br>
                                                <input id="input_txt_modal" type="number" name="t_aprendiz_apr_documento" value="<%=x.getPat_Aprendiz_Apr_documento()%>">
                                             </div>
                                    </div>

                                    <div class="row">
                                            <div class="input-field col s12 l6 m6">
                                               <p id="input_msg_modal">Numero de contrato</p>
                                               <br>
                                               <input id="input_txt_modal" type="number" name="t_numeroContrato" value="<%=x.getPat_numeroContrato()%>">
                                           </div>

                                            <div class="input-field col s12 l6 m6">
                                               <p id="input_msg_modal">Estado</p>
                                               <br>
                                               <input id="input_txt_modal" type="text" name="t_estado" value="<%=x.getPat_estado()%>">
                                           </div>
                                    </div>

                                    <div class="row">
                                            <div class="input-field col s12 l6 m6">
                                                <p id="input_msg_modal">Fecha de contrato</p>
                                                <br>
                                                <input id="input_txt_modal"  type="date" name="t_fechaContrato" value="<%=x.getPat_fechaContrato()%>">
                                            </div>                                            
                                    </div>
